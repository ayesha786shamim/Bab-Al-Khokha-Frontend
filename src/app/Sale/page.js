...
import ProductPanel from '../../components/Sales/ProductPanel';
import ListPanel from '../../components/Sales/ListPanel';
          ...
          <div className="flex-1 p-6">
            <div className="mb-8 relative w-full h-[210px] md:h-[270px] rounded-lg overflow-hidden">
              ...
              <div className="relative z-10 text-white p-20 text-center font-sans">
                <h1 className="text-5xl font-extrabold tracking-wide mb-4">Sale</h1>
                <p className="text-xl font-semibold">Sale Sale Sale!</p>
              </div>
            </div>
